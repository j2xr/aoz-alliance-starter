# Fixtures — Battle Frenzy

Ground truth pour les tests du parseur OCR `battle_frenzy`.

Battle Frenzy utilise le même layout que Polar Invasion (`PolarInvasionV1Parser`).
...
par le parseur). Le code `"battle_frenzy"` est assigné par le dispatcher en amont.
